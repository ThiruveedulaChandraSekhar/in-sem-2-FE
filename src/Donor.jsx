...
class Donor extends Component {
    ...
    componentDidMount() {
        callApi("GET", "http://localhost:30083/back1/donors/readdonor", "", this.readDonorResponse);
    }
    ...
    saveDonorDetails = () => {
        ...
        if (this.state.id === "") {
            callApi("POST", "http://localhost:30083/back1/donors/insert", data, this.saveDonorResponse);
        } else {
            callApi("PUT", "http://localhost:30083/back1/donors/update", data, this.saveDonorResponse);
        }
    }
    ...
    updateDonor(id) {
        callApi("GET", "http://localhost:30083/back1/donors/getdonor/" + id, "", this.updateDonorresponse);
    }
    ...
    deleteDonor(id) {
        ...
        if (!resp) return;
        callApi("DELETE", "http://localhost:30083/back1/donors/delete/" + id, "", this.saveDonorResponse);
    }
